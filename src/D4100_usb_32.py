...
from d4100_32 import D4100_USB_DLL_MIXIN
import os
import os.path as osp

class D4100_USB_DLL_Server32(D4100_USB_DLL_MIXIN, Server32):
    ...
    def __init__(self, host, port, quiet=False, **kwargs):
        ...
        super().__init__(osp.join(osp.dirname(osp.abspath(__file__)), os.pardir, 'lib','D4100_usb.dll'), 'cdll', host, port, quiet)
